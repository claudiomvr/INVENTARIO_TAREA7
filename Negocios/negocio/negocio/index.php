...
<div class="todo">
  ...
  <table style="margin: auto; width: 100px; border-collapse: separate; border-spacing: 30px 5px;">
  		<thead>
  		<th> <a href="index_B.php"> <button type="button" class="btn btn-info">Respaldo db</button> </a> </th>
		<th> <a href="ayuda.php"> <button type="button" class="btn btn-info">Ayuda</button> </a> </th>
  		</thead>
